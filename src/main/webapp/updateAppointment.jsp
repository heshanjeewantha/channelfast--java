...
<body>
 <ul>
  ...
  <div class="container">
    ...
    <form action="updateka" method="post">
    
    Appointment No<br><hr><br>
    	<input type="text" name="aNo" value="<%=aNo%>"readonly><br><br>
    Doctor Name<br><hr><br>
    	<input type="text" name="doctor"  required value="<%=doctor%>"><br><br>
	Patient Name<br><hr><br>
		<input type="text" name="pNmae" required value="<%=pNmae%>"><br><br>
	Gender<br><hr><br>
		<input type="text" name="gender" required value="<%=gender%>"><br><br>
	Age<br><hr><br>
		<input type="text" name="age" required value="<%=age%>"><br><br>
	Address<br><hr><br>
		<input type="text" name="address" required value="<%=address%>"><br><br>
	Contact Number<br><hr><br>
		<input type="text" name="contact" required value="<%=contact%>"><br><br>
	Email<br><hr><br>
		<input type="text" name="email" required value="<%=email%>"><br><br>
	Date<br><hr><br>
		<input type="text" name="date" required value="<%=date%>"><br><br>
	Center<br><hr><br>
		<input type="text" name="center" required value="<%=center%>"><br><br>
	...
	<div class="submit">
         <div class="button_container">
	          <button class="btn" type="submit" name="delete" required value="Update Appointment"><span>Update</span></button>
	         </div>
	         </div>
