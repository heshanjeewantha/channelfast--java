  ...
  <div class="container">
    <div class="content">
      ...
      <div class="right-side">
        <div class="topic-text">Update information</div>
...
<form action="updatec" method ="post"><br>
	Contact ID <input type="text" name="cusid" value="<%= id %>" readonly><br>
	Name <input type="text" name="name" value="<%= name %>"required><br>
	Email <input type="text" name="email" value="<%= email %>"required><br>
	Phone No <input type="text" name="phone" value="<%= phone %>" pattern="[076][0-9]{9}" maxlength="10" required><br>
	subject<input type="text" name="uname" value="<%= subject %>"required><br>
	message <input type="text" name="pass" value="<%= message %>"required><br><br>
	...
	<div class="submit">
         <div class="button_container">
	          <button class="btn" type="submit" name="submit" value="Update My Data"onclick="return confirmDelete()"><span>Update</span></button>
	         </div>
	         </div>
</form>
   </div>
